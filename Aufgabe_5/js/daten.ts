...
export let ContainerData: IceDealerData[] = [ //multidimensionales heterogenes Array
    {element: "Container", name: "", preis: 0},
    {element: "Container", name: "Cup", preis: 2},
    {element: "Container", name: "Waffle", preis: 0}
];
   
export let TheTopping: IceDealerData[] = [
...
export let IceCreamFlavours: IceDealerData[] = [
...
export let SideFruits: IceDealerData[] = [
  ...
  export let DeliveryOrPickUp: IceDealerData[] = [
